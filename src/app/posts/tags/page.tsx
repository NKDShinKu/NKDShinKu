  ...
  return (
    <div className="mx-auto w-full max-w-[880px] px-5 pt-24 pb-16 sm:px-6 md:pt-28 md:pb-24">
      <header className="mb-8">
        ...
        <h1 className="font-display mt-3 text-2xl font-bold">标签</h1>
        ...
        <nav aria-label="全部标签" className="flex flex-wrap items-center gap-2.5">
          {tags.map((tag) => (
            <Link
              ...
              className="bg-accent/10 text-accent-dark hover:bg-accent/15 focus-visible:outline-accent ease-fast rounded-full px-4 py-2 text-sm transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-offset-2"
            >
              {tag.name}
