  ...
  return (
    <div ref={rootRef} className="relative md:hidden">
      <button
        ...
        className="text-text-muted hover:text-accent ease-fast focus-visible:outline-accent flex size-11 items-center justify-center rounded-full transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-offset-2"
      >
      ...
      {open && (
        <nav
          id="mobile-menu"
          aria-label="移动端导航"
          className="border-glass-border bg-glass absolute top-[calc(100%+8px)] right-0 w-44 rounded-lg border p-2 shadow-lg backdrop-blur-[16px]"
        >
          <ul>
