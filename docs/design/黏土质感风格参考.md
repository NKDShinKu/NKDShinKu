    ...
    <div class="container">
      ...
      <section class="hero">
        <div class="hero-content">
          ...
          <h1>
            Soft, Tactile,<br /><span style="color: var(--accent-blue);"
              >Inflatable.</span
            >
          </h1>
          <p>
            Experience the digital world with a sense of touch. Claymorphism
            adds volume, depth, and a playful spirit to your interface.
          </p>
          ...
          >
            ...
            <span
              style="font-size: 0.9rem; font-weight: 600; color: var(--text-light);"
      ...
      <section class="features-grid">
        <div class="clay-card interactive">
          ...
          <h3>Anti-Flat</h3>
          <p>
            Rejecting sharp edges for a world made of soft, matte rubber.
            Everything feels touchable.
          </p>
        </div>
        ...
        <div class="clay-card interactive">
          ...
          <h3>Deep Layers</h3>
          <p>
            Using dual inner shadows to create volume, making elements look like
            they are inflated.
          </p>
        </div>
        ...
        <div class="clay-card interactive">
          ...
          <h3>Playful Vibes</h3>
          <p>
            Perfect for education, casual games, and creative portfolios. Safe,
            round, and friendly.
          </p>
        </div>
      </section>
        ...
        <div class="sandbox-grid">
          ...
          <div class="clay-card">
            ...
            <form onsubmit="event.preventDefault()">
              ...
              <button class="clay-btn btn-primary" style="width: 100%">
                Save Changes
              </button>
            </form>
          </div>
